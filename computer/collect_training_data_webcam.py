        ...
        try:
            ...
            while self.send_inst:
                while True:
                    ...
                    d = self.connection.recv(304128)

                    if not d and len(stream_bytes) < 304128:
                        break

                    else:
                        stream_bytes += d

                    if len(stream_bytes) == 304128:

                        confirm_message = "Received"
                        self.connection.sendall(confirm_message)
